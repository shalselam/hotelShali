...
const ListLink = () => {
    const [show,setShhow]=useState(false)
    const showHandling = () =>{
        setShhow((name)=>{
            return !name
        })
...
return (
        <div className="main-list-cotainer" onMouseEnter={()=>{setShhow(true)}} onMouseLeave={()=>{
                     setShhow(false)
                }}>
            <div className="">
            ...
            <div  style={{display: show ?'':'none'}} className="glass all-list">
                <div className="glss-item flex-grow">
