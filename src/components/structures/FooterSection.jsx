            ...
            <div className=" footers">
                <div className="flex-grow"  >
                    <div className=" footer-container" style={{ maxWidth: '1300 !important' }}>
                        ...
                        <div className="subsribing center">
                            <p>subsribe to our newsletter for news and ever.</p>
                            <div className="footer-email">
                                ...
                                <input
                                    ...
                                    tabIndex="3"
                                />
                                <button type="submit" className="send btn">Subscribe</button>
                            </div>
                        </div>

                        <div className="icons_item last-icon">
                            <p style={{fontSize:'1.3rem'}}>Follow Us</p>
